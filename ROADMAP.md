...
- 2026-07-17: **Mobile-LP-Race behoben (Cron-Pass)**: `learn.tsx`, `practice.tsx` und `cloze.tsx` warten auf laufende Reviews und wiederholen `earnLp` kurz — verhindert dauerhaft verlorene Lernpunkte beim schnellen Tab-Wechsel (#153-Follow-up, gleiches Muster wie Web `learn-session-lp`).

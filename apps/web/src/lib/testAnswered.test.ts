...
// Was beim vorzeitigen Verlassen einer Prüfung gemeldet wird, hängt allein an
// dieser Regel. Fiele sie zu großzügig aus, bekämen unberührte Karten ein
// „nicht gewusst" — und das verstellt den Lernplan aufgrund von Schweigen.
